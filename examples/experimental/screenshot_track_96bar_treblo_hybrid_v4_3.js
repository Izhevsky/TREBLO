// ═══════════════════════════════════════════════════════════════════════════
// SCREENSHOT TRACK — 96 BAR TREBLO HYBRID v4.3
// 122 BPM · A minor
//
// Goal:
...
// - current TREBLO sample set passed user browser audition on 2026-09-22
// ═══════════════════════════════════════════════════════════════════════════
...
const D2 = stack(KICK, CLAP, HATS, HAT_ACCENT, OPENHAT, PERC_A, BASS_A, CHORDS_A, GUITAR_A)
const D3 = stack(KICK, CLAP, HATS, HAT_ALT, OPENHAT, TOM, PERC_B, BASS_B, CHORDS_A, STAB_A, GUITAR_A)
const D4 = stack(KICK, CLAP, HATS, HAT_ALT, OPENHAT, TOM_ALT, PERC_B, BASS_B, CHORDS_B, STAB_B, GUITAR_B, LEAD_A)
const D5 = stack(KICK_SOFT, CLAP_LIGHT, HATS_DARK, BASS_B, CHORDS_B, GUITAR_A, LEAD_A)
const D6 = stack(KICK_PEAK, CLAP, HATS, HAT_ALT, OPENHAT_PEAK, TOM, TOM_ALT, PERC_B, BASS_B, CHORDS_B, STAB_B, GUITAR_B, LEAD_A)

const C1 = stack(KICK_PEAK, CLAP_PEAK, HATS, HAT_ALT, OPENHAT_PEAK, TOM, PERC_B, BASS_PEAK, CHORDS_B, CHORDS_HIGH, STAB_A, GUITAR_A, LEAD_A)
const C2 = stack(KICK_PEAK, CLAP_PEAK, HATS, HAT_ALT, OPENHAT_PEAK, RIDE, TOM_ALT, PERC_B, BASS_PEAK, CHORDS_B, CHORDS_HIGH, STAB_B, GUITAR_B, LEAD_B, PAD)
const C3 = stack(KICK, HATS_DARK, OPENHAT, BASS_B, CHORDS_BRIDGE, GUITAR_A, BRIDGE_LEAD, PAD)
const C4 = stack(KICK_PEAK, CLAP_PEAK, HATS, HAT_ALT, OPENHAT_PEAK, RIDE, CRASH, TOM, TOM_ALT, PERC_B, BASS_PEAK, CHORDS_B, CHORDS_HIGH, STAB_B, GUITAR_PEAK, LEAD_PEAK, PAD)

const B1 = stack(KICK_BRIDGE, HATS_DARK, BASS_BRIDGE, CHORDS_BRIDGE, BRIDGE_LEAD, PAD)
const B2 = stack(KICK_BRIDGE, HATS_DARK, HAT_ACCENT, BASS_BRIDGE, CHORDS_BRIDGE, GUITAR_A, BRIDGE_LEAD)
const B3 = stack(KICK, CLAP_LIGHT, HATS_DARK, HAT_ACCENT, BASS_A, CHORDS_A, STAB_A, GUITAR_A)
const B4 = stack(KICK_PEAK, CLAP, HATS, HAT_ALT, OPENHAT, TOM_ALT, PERC_A, BASS_B, CHORDS_B, STAB_B, GUITAR_B, LEAD_B)

const O1 = stack(KICK, CLAP, HATS, HAT_ACCENT, OPENHAT, PERC_A, BASS_A, CHORDS_A, STAB_A, GUITAR_A, LEAD_A)
